...
export default function ToolPanel({ className = '' }: ToolPanelProps) {
  ...
  return (
    <FoldedPanel className={`flex min-h-0 flex-col overflow-hidden ${className}`} bg="bg-dionysus-floating-bg" borderColor="border-white/10" innerClassName="cel-dark-card p-4">
